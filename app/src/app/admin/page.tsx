              ...
              fields={[
                ...
                { key: "email", label: t("auth.email"), required: true },
                {
                  ...
                  options: [
                    ...
                    { value: "sideline_official_a",     label: t("role.sideline_official_a") },
                    { value: "sideline_official_b",     label: t("role.sideline_official_b") },
                    { value: "team_manager_a",          label: t("role.team_manager_a") },
                    { value: "team_manager_b",          label: t("role.team_manager_b") },
